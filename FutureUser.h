...
namespace Autolibrary {
	...
	/// <summary>
	/// Summary for FutureUser
	/// </summary>
	public ref class FutureUser : public System::Windows::Forms::Form
	{
	public:
		FutureUser(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(579, 37);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 8;
			this->button1->Text = L"Оновити";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &FutureUser::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Size = System::Drawing::Size(550, 26);
			this->label1->TabIndex = 7;
			this->label1->Text = L"Книги, які скоро будуть доступні у бібліотеці";
			// 
			// listView1
			// 
			...
			this->listView1->Location = System::Drawing::Point(47, 66);
			...
			// columnHeader1
			// 
			this->columnHeader1->Text = L"Назва";
			this->columnHeader1->Width = 328;
			// 
			// columnHeader2
			// 
			this->columnHeader2->Text = L"Автор";
			this->columnHeader2->Width = 170;
			// 
			// columnHeader3
			// 
			this->columnHeader3->Text = L"Рік видання";
			...
			this->ClientSize = System::Drawing::Size(808, 361);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->label1);
			this->Controls->Add(this->listView1);
			this->Name = L"FutureUser";
			this->Text = L"FutureUser";
