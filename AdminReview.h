...
namespace Autolibrary {
	...
	/// <summary>
	/// Summary for AdminReview
	/// </summary>
	public ref class AdminReview : public System::Windows::Forms::Form
	{
	public:
		AdminReview(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(514, 51);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 5;
			this->button1->Text = L"Оновити";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &AdminReview::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"У наявності";
			// 
			// listView1
			// 
